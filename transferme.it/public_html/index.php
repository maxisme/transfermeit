	...
	<page id="contact">
        ...
        ***REMOVED***
		if($_SESSION["error"] > 0 && $_SESSION["error"] < 5){
			...
			***REMOVED***else if($_SESSION["error"] == 2){
				echo "Error: No Name";
			***REMOVED***else if($_SESSION["error"] == 3){
				echo "Error: No Message";
			***REMOVED***else if($_SESSION["error"] == 4){
				echo "Error: Invalid Email";
			***REMOVED***
			echo "</span>
		"; $_SESSION["error"] = NULL; ***REMOVED***else if($_SESSION["success"] == 1){ echo "<span class='email_note' style='color:#2A682E'>Success! We will get back to you as soon as possible!</span>"; $_SESSION["success"] = NULL; ***REMOVED*** ***REMOVED***
		</div>
